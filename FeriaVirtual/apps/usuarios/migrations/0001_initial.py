    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('productor', 'Productor'), ('interno', 'Interno'), ('externo', 'Externo'), ('consultor', 'Consultor'), ('transportista', 'Transportista'), ('administrador', 'Administrador'), ('revisor calidad', 'Revisor Calidad')], default='externo', max_length=50)),
