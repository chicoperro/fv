...
class usuarios(AbstractBaseUser, PermissionsMixin):
	...
	tipos = (('productor','Productor'),('interno','Interno'),('externo','Externo'),('consultor','Consultor'),('transportista','Transportista'),('administrador','Administrador'),('revisor calidad','Revisor Calidad'))
